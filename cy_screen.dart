...
import 'package:edu_app/screens/cy_module.dart';
...
class CYPage extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Column(
        ...
        children: [
          Image.network(
            'assets/images/q.jpeg', // Replace with the actual image URL
            height: 200,
          ...
          DegreeButton('Modules',(){
            Navigator.push(context, MaterialPageRoute(builder: (context) => CYModuleScreen()));
          }
