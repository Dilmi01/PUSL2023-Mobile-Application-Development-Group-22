...
import 'package:edu_app/screens/cs_module.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Column(
        ...
        children: [
          Image.network(
            'assets/images/k.jpg', // Replace with the actual image URL
            height: 200,
          ...
          DegreeButton('Modules',(){
            Navigator.push(context, MaterialPageRoute(builder: (context) => CSModuleScreen()));
          }
