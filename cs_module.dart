          ...
          itemBuilder: (context, index) {
            return GestureDetector(
              onTap: () {
                ...
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => CSMadScreen(moduleName: modules[index])),
                );
              },
              child: Container(
